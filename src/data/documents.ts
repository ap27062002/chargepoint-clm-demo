...
// CP-authored tracked changes (no `party` → defaults to our-side styling, not counterparty's).
const insUs = (text: string, cid: string): DocRun => ({ text, type: 'ins', cid })
const delUs = (text: string, cid: string): DocRun => ({ text, type: 'del', cid })
...
// ---- Northwind DPA \u2014 outbound redline: CP's own tracked changes to our standard DPA,
// sent to Northwind and awaiting their response (demo: every doc type needs real content). ----
const northwindDpaV1 = (): DocModel => ({
  versionId: 'V-2181-1',
  title: 'DATA PROCESSING ADDENDUM',
  subtitle: 'ChargePoint, Inc. and Northwind Energy \u2014 V1 (ChargePoint standard DPA, 2026-06-05)',
  clauses: [
    { id: 'dpa-preamble', ref: '', heading: '', runs: [n('This Data Processing Addendum ("DPA") supplements the Master Services Agreement between ChargePoint, Inc. ("Processor") and Northwind Energy ("Controller") and governs Processor\u2019s processing of Personal Data on Controller\u2019s behalf.')] },
    { id: 'dpa-c1', ref: '\u00a71', heading: '1. Scope & Duration of Processing', runs: [n('Processor will process Personal Data only for the duration of the underlying Master Services Agreement and solely to provide the charging-as-a-service program described therein.')] },
    { id: 'dpa-c2', ref: '\u00a72', heading: '2. Sub-processors', runs: [n('Processor may engage sub-processors and will maintain a current list available on request. Processor will provide thirty (30) days\u2019 advance notice of any new sub-processor.')] },
    { id: 'dpa-c3', ref: '\u00a73', heading: '3. Security Measures', runs: [n('Processor will implement appropriate technical and organizational measures, including encryption in transit and at rest, access controls, and periodic security testing.')] },
    { id: 'dpa-c4', ref: '\u00a74', heading: '4. Data Subject Rights Assistance', runs: [n('Processor will provide reasonable assistance to Controller in responding to data-subject requests, at Controller\u2019s expense for extraordinary effort.')] },
    { id: 'dpa-c5', ref: '\u00a75', heading: '5. International Transfers', runs: [n('Where Personal Data is transferred outside the region of origin, the parties will rely on the Standard Contractual Clauses (2021 EU SCCs) as incorporated by reference.')] },
    { id: 'dpa-c6', ref: '\u00a76', heading: '6. Audit Rights', runs: [n('Controller may audit Processor\u2019s compliance with this DPA no more than once per twelve (12) month period, on sixty (60) days\u2019 written notice.')] },
    { id: 'dpa-c7', ref: '\u00a77', heading: '7. Breach Notification', runs: [n('Processor will notify Controller of a confirmed Personal Data breach without undue delay, and in any event within seventy-two (72) hours of becoming aware.')] },
  ],
})
const northwindDpaV2 = (): DocModel => ({
  versionId: 'V-2181-2',
  title: 'DATA PROCESSING ADDENDUM',
  subtitle: 'ChargePoint, Inc. and Northwind Energy \u2014 V2 (ChargePoint redline, sent 21 Jun 2026 \u2014 awaiting Northwind response)',
  clauses: [
    { id: 'dpa-preamble', ref: '', heading: '', runs: [n('This Data Processing Addendum ("DPA") supplements the Master Services Agreement between ChargePoint, Inc. ("Processor") and Northwind Energy ("Controller") and governs Processor\u2019s processing of Personal Data on Controller\u2019s behalf.')] },
    { id: 'dpa-c1', ref: '\u00a71', heading: '1. Scope & Duration of Processing', runs: [n('Processor will process Personal Data only for the duration of the underlying Master Services Agreement and solely to provide the charging-as-a-service program described therein.')] },
    { id: 'dpa-c2', ref: '\u00a72', heading: '2. Sub-processors', runs: [
      n('Processor may engage sub-processors and will maintain a current list available on request. Processor will provide '),
      delUs('thirty (30) days\u2019', 'dpa-ch-2del'), insUs('fourteen (14) days\u2019', 'dpa-ch-2ins'),
      n(' advance notice of any new sub-processor.'),
    ] },
    { id: 'dpa-c3', ref: '\u00a73', heading: '3. Security Measures', runs: [n('Processor will implement appropriate technical and organizational measures, including encryption in transit and at rest, access controls, and periodic security testing.')] },
    { id: 'dpa-c4', ref: '\u00a74', heading: '4. Data Subject Rights Assistance', runs: [n('Processor will provide reasonable assistance to Controller in responding to data-subject requests, at Controller\u2019s expense for extraordinary effort.')] },
    { id: 'dpa-c5', ref: '\u00a75', heading: '5. International Transfers', runs: [n('Where Personal Data is transferred outside the region of origin, the parties will rely on the Standard Contractual Clauses (2021 EU SCCs) as incorporated by reference.')] },
    { id: 'dpa-c6', ref: '\u00a76', heading: '6. Audit Rights', runs: [
      n('Controller may audit Processor\u2019s compliance with this DPA no more than '),
      delUs('once per twelve (12) month period, on sixty (60) days\u2019', 'dpa-ch-6del'), insUs('once per twenty-four (24) month period, on ninety (90) days\u2019', 'dpa-ch-6ins'),
      n(' written notice.'),
    ] },
    { id: 'dpa-c7', ref: '\u00a77', heading: '7. Breach Notification', runs: [
      n('Processor will notify Controller of a confirmed Personal Data breach without undue delay, and in any event within '),
      delUs('seventy-two (72) hours', 'dpa-ch-7del'), insUs('forty-eight (48) hours', 'dpa-ch-7ins'),
      n(' of becoming aware.'),
    ] },
  ],
})

// ---- Northwind SOW \u2014 finalized, ready to sign (no open tracked changes). ----
const northwindSowV2 = (): DocModel => ({
  versionId: 'V-2182-2',
  title: 'STATEMENT OF WORK',
  subtitle: 'ChargePoint, Inc. and Northwind Energy \u2014 V2 Final (terms finalized, 23 Jun 2026 \u2014 ready to sign)',
  clauses: [
    { id: 'sow-preamble', ref: '', heading: '', runs: [n('This Statement of Work ("SOW") is issued under the Master Services Agreement between ChargePoint, Inc. and Northwind Energy and describes the initial charging-as-a-service deployment.')] },
    { id: 'sow-c1', ref: '\u00a71', heading: '1. Scope of Work', runs: [n('ChargePoint will install, commission, and operate twenty-four (24) Level 2 charging stations across three (3) Northwind depot sites, per the site plans attached as Exhibit A.')] },
    { id: 'sow-c2', ref: '\u00a72', heading: '2. Deliverables & Milestones', runs: [n('Site survey and readiness report (Week 2); station installation and commissioning (Week 8); go-live and driver-app rollout (Week 10); 30-day performance report (Week 14).')] },
    { id: 'sow-c3', ref: '\u00a73', heading: '3. Fees & Payment Schedule', runs: [n('Total fees of $412,000, invoiced 40% on signing, 40% on commissioning, and 20% on go-live acceptance, net thirty (30) days.')] },
    { id: 'sow-c4', ref: '\u00a74', heading: '4. Term', runs: [n('This SOW commences on the Effective Date and continues for the initial two (2) year term of the Master Services Agreement, subject to the same renewal terms.')] },
    { id: 'sow-c5', ref: '\u00a75', heading: '5. Acceptance Criteria', runs: [n('Stations are deemed accepted upon successful completion of the 30-day performance report showing 98% or greater uptime, or automatically thirty (30) days after go-live absent written objection.')] },
    { id: 'sow-c6', ref: '\u00a76', heading: '6. Roles & Responsibilities', runs: [n('Northwind will provide site access, electrical service to the point of connection, and a single point of contact for scheduling. ChargePoint is responsible for all installation labor, permitting support, and ongoing maintenance.')] },
  ],
})

export function seedDocuments(): Record<string, DocModel> {
  return {
    'V-2201-1': vishayV1(), 'V-2201-2': vishayDraft2(), 'V-2201-3': vishayV3(), 'V-2201-3C': vishayV3Clean(),
    'V-2180-2': northwindV2(), 'V-2180-3': northwindV3(),
    'V-2181-1': northwindDpaV1(), 'V-2181-2': northwindDpaV2(),
    'V-2182-2': northwindSowV2(),
  }
}
